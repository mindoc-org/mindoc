        ...
        <div class="row">
            <div class="page-left">
                <ul class="menu">
                    ...
                    <li class="active"><a href="{{urlfor "ManagerController.BookUsers" ":key" .Model.Identify}}" class="item">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-users" aria-hidden="true"></i> 成员</a> </li>
                    {{if eq .Model.RoleId 0 1}}
                    <li><a href="{{urlfor "ManagerController.BookSetting" ":key" .Model.Identify}}" class="item">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-gear" aria-hidden="true"></i> 设置</a> </li>
                    {{end}}
