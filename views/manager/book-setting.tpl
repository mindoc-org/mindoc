        ...
        <div class="row">
            <div class="page-left">
                <ul class="menu">
                    ...
                    <li class="active"><a href="###" class="item"><i class="fa fa-dashboard" aria-hidden="true"></i> {{.Model.BookName}}</a> </li>
                    <li><a href="{{urlfor "ManagerController.BookDashboard" ":key" .Model.Identify}}" class="item">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-dashboard" aria-hidden="true"></i> 概要</a> </li>
                    <li><a href="{{urlfor "ManagerController.BookUsers" ":key" .Model.Identify}}" class="item">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-users" aria-hidden="true"></i> 成员</a> </li>
                    {{if eq .Model.RoleId 0 1}}
                    <li class="active"><a href="{{urlfor "ManagerController.BookSetting" ":key" .Model.Identify}}" class="item">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-gear" aria-hidden="true"></i> 设置</a> </li>
                    {{end}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label class="radio-inline">
                                        <input type="radio"{{if eq .Model.Editor "markdown"}} checked{{end}} name="editor" value="markdown" disabled> Markdown编辑器
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio"{{if eq .Model.Editor "html"}} checked{{end}} name="editor" value="html" disabled> Html编辑器
                                    </label>
                                </div>
                            </div>
                            <!--
